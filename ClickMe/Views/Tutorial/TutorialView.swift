...
class TutorialView: UIView {
    ...
    private func setupTheme() {
        ...
        bodyTextLabel.textColor = theme.indigo.hexColor
        topTriangle.fillColor = theme.whiteBackground.hexColor
        bottomTriangle.fillColor = theme.whiteBackground.hexColor
        tutorialContainerView.backgroundColor = theme.whiteBackground.hexColor
